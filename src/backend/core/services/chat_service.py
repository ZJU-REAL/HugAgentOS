...
class ChatService:
    ...
    def get_session(self, chat_id: str, user_id: str) -> Optional[ChatSession]:
        ...
        Historical semantics unchanged: only the owner can get the session. For **team-project
        sharing scenarios**, use :py:meth:`get_session_with_access` instead, which decides based
        on share_scope + project permissions.
        """
    ...
    def delete_session_force(
        self, chat_id: str, *, actor_user_id: str
    ) -> bool:
    ...
    def upsert_message(
        ...
        *,
        ...
        return self.add_message(
            chat_id=chat_id, role=role, content=content, tool_calls=tool_calls,
            usage=usage, extra_data=extra_data, message_id=message_id,
        )
    ...
    def list_all_messages(self, chat_id: str, user_id: str) -> Optional[List[ChatMessage]]:
        ...
        Sharing context: team_read / team_edit members can also read.
        ...
        *,
        ...
        message = self.message_repo.create({
            ...
            "extra_data": {
                ...
                "covers_up_to_created_at": last.created_at.isoformat() if last and last.created_at else None,
